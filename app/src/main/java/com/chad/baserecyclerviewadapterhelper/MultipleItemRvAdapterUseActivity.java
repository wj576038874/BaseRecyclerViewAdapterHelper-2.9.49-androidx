...
public class MultipleItemRvAdapterUseActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        multipleItemAdapter.addHeaderView(view);
...
//                    Toast.makeText(MultipleItemRvAdapterUseActivity.this, "multipleItemAdapter"+textView.getText().toString(), Toast.LENGTH_SHORT).show();
//                }
//            }
//        });
